...
export class RaynetApi implements ICredentialType {
    ...
    properties: INodeProperties[] = [
        ...
        },
        {
            ...
            default: '',
            required: true,
            description: 'Name of the CRM instance. This can be found in the logged in RAYNET CRM app URL. For example, in https://app.raynet.cz/demo/, demo would be the instance name.',
        },
        {
            displayName: 'Server',
            name: 'server',
            ...
            description: 'The server on which your CRM instance can be found. This can be read as the URL address you get redirected to after logging into RAYNET CRM.',
            options: [
