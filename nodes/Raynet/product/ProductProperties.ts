    ...
    return [
        {
            ...
            options: [
                { name: 'Create', value: 'create', description: 'Create a new product' },
                { name: 'Update', value: 'update', description: 'Update an existing product' },
                { name: 'Get', value: 'get', description: 'Get a product by ID' },
                { name: 'Get Many', value: 'getMany', description: 'List products with filters' },
                { name: 'Delete', value: 'delete', description: 'Delete a product' },
                { name: 'Invalidate', value: 'invalidate', description: 'Mark a product as invalid' },
                { name: 'Renew Validity', value: 'renewValidity', description: 'Restore a previously invalidated product' },
            ],
        },
    ];
}
