    ...
    return [
        {
            ...
            options: [
                { name: 'Create', value: 'create', description: 'Create a new sales order' },
                { name: 'Update', value: 'update', description: 'Update an existing sales order' },
                { name: 'Get', value: 'get', description: 'Get a sales order by ID' },
                { name: 'Get Many', value: 'getMany', description: 'List sales orders with filters' },
                { name: 'Delete', value: 'delete', description: 'Delete a sales order' },
                { name: 'Lock', value: 'lock', description: 'Lock a sales order to prevent changes' },
                { name: 'Unlock', value: 'unlock', description: 'Unlock a locked sales order' },
                { name: 'Invalidate', value: 'invalidate', description: 'Mark a sales order as invalid' },
                { name: 'Renew Validity', value: 'renewValidity', description: 'Renew validity of an invalidated sales order' },
                { name: 'Add Tag', value: 'addTag', description: 'Add a tag to a sales order' },
                { name: 'Remove Tag', value: 'deleteTag', description: 'Remove a tag from a sales order' },
                { name: 'Add Item', value: 'addItem', description: 'Add an item to a sales order' },
                { name: 'Modify Item', value: 'modifyItem', description: 'Update an item in a sales order' },
                { name: 'Delete Item', value: 'deleteItem', description: 'Remove an item from a sales order' },
            ],
        },
    ];
}
