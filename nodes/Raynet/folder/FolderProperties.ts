    ...
    return [
        {
            ...
            options: [
                { name: 'Create', value: 'create', description: 'Create a new DMS folder', action: 'Create a folder' },
                { name: 'Delete', value: 'delete', description: 'Delete a DMS folder', action: 'Delete a folder' },
            ],
        },
