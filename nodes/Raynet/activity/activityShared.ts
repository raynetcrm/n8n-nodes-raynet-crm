...
export function getActivityProperties(def: ActivityDef): INodeProperties[] {
    ...
    return [
        // Operation selector
        {
            ...
            options: [
                { name: 'Create', value: 'create', description: `Create a ${def.resource}` },
                { name: 'Delete', value: 'delete', description: `Delete a ${def.resource}` },
                { name: 'Get', value: 'get', description: `Get a ${def.resource} by ID` },
                { name: 'Get Many', value: 'getMany', description: `List ${def.resource}s with filters` },
                { name: 'Lock', value: 'lock', description: `Lock a ${def.resource} record` },
                { name: 'Unlock', value: 'unlock', description: `Unlock a ${def.resource} record` },
                { name: 'Update', value: 'update', description: `Update a ${def.resource}` },
            ],
        },
