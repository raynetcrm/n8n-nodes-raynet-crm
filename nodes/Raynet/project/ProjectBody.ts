...
export function buildProjectBody(ctx: IExecuteFunctions, operation: 'create' | 'update', i: number): Record<string, unknown> {
...
export function buildAddParticipantBody(ctx: IExecuteFunctions, i: number): Record<string, unknown> {
    const body: Record<string, unknown> = {};
    const fields = ctx.getNodeParameter('participantFields', i, {}) as Record<string, unknown>;
