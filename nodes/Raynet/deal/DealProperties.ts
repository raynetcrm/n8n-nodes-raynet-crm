...
const SHARED_OPTIONAL_FIELDS: INodeProperties[] = [
  ...
  { displayName: 'Currency', name: 'currency', type: 'options', default: '', typeOptions: { loadOptionsMethod: 'getCurrencies' } },
  ...
  return [
    {
      ...
      options: [
        ...
        { name: 'Renew Validity', value: 'renewValidity', description: 'Renew validity of an invalidated deal' },
...
function getUpdateProperties(): INodeProperties[] {
  return [
    { displayName: 'Deal ID', name: 'dealId', type: 'number', required: true, default: 0, displayOptions: op([OperationType.UPDATE]) },
    {
...
function getGetProperties(): INodeProperties[] {
  return [{ displayName: 'Deal ID', name: 'dealId', type: 'number', required: true, default: 0, displayOptions: op([OperationType.GET]) }];
}
...
function getDeleteProperties(): INodeProperties[] {
  return [{ displayName: 'Deal ID', name: 'dealId', type: 'number', required: true, default: 0, displayOptions: op([OperationType.DELETE]) }];
}
...
function getTagProperties(): INodeProperties[] {
  return [
    { displayName: 'Deal ID', name: 'dealId', type: 'number', required: true, default: 0, displayOptions: op([OperationType.ADD_TAG]) },
    { displayName: 'Tag', name: 'tag', type: 'string', required: true, default: '', displayOptions: op([OperationType.ADD_TAG]) },
    { displayName: 'Deal ID', name: 'dealId', type: 'number', required: true, default: 0, displayOptions: op([OperationType.DELETE_TAG]) },
