...
const SHARED_OPTIONAL_FIELDS: INodeProperties[] = [
    {
        ...
        description: 'Security level for this quote. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    },
    {
        ...
        description: 'User responsible for this quote. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    },
    {
        ...
        type: 'number',
        default: 0,
        description: 'ID of the contact person on the account side',
    },
    ...
    { displayName: 'Estimated Costs', name: 'estimatedValue', type: 'number', default: 0 },
    {
        ...
        type: 'dateTime',
        default: '',
        description: 'Date of creation / opening',
    },
    {
    ...
    },
    {
        ...
        type: 'dateTime',
        default: '',
        description: 'End of quote validity',
    },
    {
        displayName: 'Note',
        name: 'description',
    ...
    },
    {
        ...
        default: '',
        typeOptions: { loadOptionsMethod: 'getOfferCategories' },
    },
    {
        ...
        type: 'options',
								description: 'Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>',
        default: '',
        typeOptions: { loadOptionsMethod: 'getOfferStatuses' },
    },
    {
        displayName: 'Tags',
        name: 'tags',
...
const op = (operations: OperationType | OperationType[]) => showOptionsForOp(operations, 'quote');
    ...
    return [
        {
            ...
            options: [
                { name: 'Add Item', value: 'addItem', description: 'Add an item to a quote', action: 'Add item a quote' },
                { name: 'Add Tag', value: 'addTag', description: 'Add a tag to a quote', action: 'Add tag a quote' },
                ...
                { name: 'Delete Item', value: 'deleteItem', description: 'Remove an item from a quote', action: 'Delete item a quote' },
                { name: 'Get', value: 'get', description: 'Get a quote by ID', action: 'Get a quote' },
                { name: 'Get Many', value: 'getMany', description: 'List quotes with filters', action: 'Get many a quote' },
                { name: 'Invalidate', value: 'invalidate', description: 'Mark a quote as invalid', action: 'Invalidate a quote' },
                { name: 'Lock', value: 'lock', description: 'Lock a quote to prevent changes', action: 'Lock a quote' },
                { name: 'Modify Item', value: 'modifyItem', description: 'Update an item in a quote', action: 'Modify item a quote' },
                { name: 'Remove Tag', value: 'deleteTag', description: 'Remove a tag from a quote', action: 'Remove tag a quote' },
                {
                    name: 'Renew Validity',
                    value: 'renewValidity',
                    description: 'Renew validity of an invalidated quote',
                    action: 'Renew validity a quote',
                },
                { name: 'Unlock', value: 'unlock', description: 'Unlock a locked quote', action: 'Unlock a quote' },
                { name: 'Update', value: 'update', description: 'Update an existing quote', action: 'Update a quote' },
            ],
        },
    ];
}
    ...
    return [
        {
            ...
            required: true,
            default: '',
            description: 'Subject / name of the quote',
        ...
        },
        {
            ...
            required: true,
            default: 0,
            description: 'ID of the account the quote is created for',
            displayOptions: op(OperationType.CREATE),
        },
        {
            displayName: 'Deal ID',
            ...
            required: true,
            default: 0,
            description: 'ID of the deal this quote belongs to',
            displayOptions: op(OperationType.CREATE),
        },
        {
...
export function getQuoteProperties(): INodeProperties[] {
    return [
