        ...
        options: [
            {
                ...
                values: [
                    ...
                    {
                        displayName: 'Item ID (Update Only)',
                        name: 'id',
                        type: 'number',
                        default: 0,
    ...
    return [
        {
            ...
            options: [
                ...
                { name: 'Get Many', value: 'getMany', description: 'List invoices with filters', action: 'Get a list of invoices' },
                { name: 'Lock', value: 'lock', description: 'Lock an invoice record', action: 'Lock an invoice' },
                { name: 'Unlock', value: 'unlock', description: 'Unlock an invoice record', action: 'Unlock an invoice' },
